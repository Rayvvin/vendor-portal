...
import WalletListComp from "./WalletListComp";
import {
  TrendingUp,
  TrendingDown,
  Category,
...
import WalletAsideComp from "./WalletAsideComp";
  ...
  const stats = [
    ...
    },
    {
      ...
      value:
        identity &&
        identity.data &&
        identity.data.medusa_wallet &&
        identity.data.medusa_wallet.total_balance[

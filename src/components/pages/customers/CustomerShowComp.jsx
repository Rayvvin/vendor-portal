...
// import CustomerAsideComp from "./CustomerAsideComp";
...
export default function CustomerShowComp(props) {
  const { setShowTitle, customer, setCustomer } = props;
  ...
  return (
    <SimpleShowLayout sx={{ backgroundColor: "transparent", padding: "0px" }}>
      ...
      >
                ...
                >
                  <Stack>
                    <Splide
                      ...
                      aria-label="Customer Images big"
                      options={{
                        arrows: false,
                        autoplay: true,
                        type: "loop",
                  ...
                  >
                    <Splide
                      ...
                      aria-label="Customer Images small"
                      options={{
        ...
        <CustomerSummary currncy={currncy} record={record} />
          ...
          >
            ...
            >
              <List
                ...
                error={false}
                pagination={false}
                filter={record && record.id ? { customer_id: record.id } : null}

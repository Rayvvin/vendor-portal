...
import CustomerShowComp from "./CustomerShowComp";
...
const Aside = ({ customer, setCustomer }) => {
  ...
  return (
    <>
      {isXLarge ? null : (
        ...
        >
          {/* <CustomerAsideComp customer={customer} setCustomer={setCustomer} /> */}
        </Stack>
      )}
    </>
  );

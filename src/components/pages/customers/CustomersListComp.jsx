...
export default function CustomerListComp(props) {
    ...
    >
      {isSmall ? (
        <SimpleList
          ...
          leftAvatar={(record) => (
            <Avatar
              {...stringAvatar(`${record.first_name} ${record.last_name}`)}
            />
          )}
        ...
        <Datagrid size="medium" bulkActionButtons={false} rowClick="show">
          ...
          {/* <TextField source="id" /> */}
          <CustomerField label="Name" />
          <TextField source="email" />
          {/* <TextField source="first_name" />
        <TextField source="last_name" /> */}
          {/* <ReferenceField source="billing_address_id" reference="billing_addresses" /> */}
          {/* <TextField source="password_hash" /> */}
          <OrdersCountField label="Orders" />
          {/* <BooleanField source="has_account" /> */}

...
import CollectionStationsAsideComp from "./CollectionStationsAsideComp";
import Medusa from "@medusajs/medusa-js";
import CollectionStationsShowComp from "./CollectionStationsShowComp";
...
const CollectionStationsShowActions = ({ basePath, data, resource }) => {
  ...
  return (
    <>
      {isXLarge ? null : (
        ...
        >
          <CollectionStationsAsideComp product={product} setProduct={setProduct} />
        </Stack>
      )}
    </>
  );
...
export const CollectionStationsShow = () => {
  ...
  return (
    <Show
      title={showTitle}
      actions={<CollectionStationsShowActions />}

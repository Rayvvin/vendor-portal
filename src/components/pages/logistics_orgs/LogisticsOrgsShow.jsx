...
import LogisticsOrgAsideComp from "./LogisticsOrgsAsideComp";
import Medusa from "@medusajs/medusa-js";
import LogisticsOrgShowComp from "./LogisticsOrgsShowComp";
...
const LogisticsOrgShowActions = ({ basePath, data, resource }) => {
  ...
  return (
    <>
      {isXLarge ? null : (
        ...
        >
          <LogisticsOrgAsideComp product={product} setProduct={setProduct} />
        </Stack>
      )}
    </>
  );
...
export const LogisticsOrgShow = () => {
  ...
  return (
    <Show
      title={showTitle}
      actions={<LogisticsOrgShowActions />}

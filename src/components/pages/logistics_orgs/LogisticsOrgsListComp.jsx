...
export default function LogisticsOrgsListComp(props) {
    ...
    >
      {isSmall ? (
        <SimpleList
          ...
          secondaryText={(record) => (
            <Stack direction="row" spacing={1} divider={<p>-</p>}>
              ...
              <RegionField source="Regions" regionsIds={regionIds} />
              <DateField
                source="created_at"
                options={{
                  year: "numeric",
        ...
        <Datagrid size="small" bulkActionButtons={false} rowClick="show">
          {/* <TextField source="id" /> */}
          <TextField source="name" />
          <TextField source="contact_info.email" label="Contact Email" />
          <RegionField source="Regions" regionsIds={regionIds} />
          <ReferenceManyCount
            label="Deliveries"

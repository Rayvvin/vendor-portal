...
export default function DiscountListComp(props) {
  ...
  return (
    ...
    >
      <Datagrid size="medium" bulkActionButtons={false}>
        ...
        {/* <BooleanField source="is_dynamic" />
        <ReferenceField source="rule_id" reference="rules" />
        <BooleanField source="is_disabled" />
        <ReferenceField
          source="parent_discount_id"
          reference="parent_discounts"
        /> */}
        <DateField source="starts_at" />
        <TextField source="ends_at" />
        {/* <TextField source="deleted_at" />
        <TextField source="metadata" /> */}
        <TextField source="usage_limit" />
        <TextField source="usage_count" />
        <TextField source="valid_duration" />
        <DateField
          source="created_at"
          options={{
            year: "numeric",

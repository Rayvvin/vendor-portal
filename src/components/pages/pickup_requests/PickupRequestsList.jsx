...
import CustomerListComp from "./PickupRequestsListComp";
import { toTitleCase } from "../../helpers/helpers";
import PickupRequestsListComp from "./PickupRequestsListComp";
import {
  TrendingUp,
  TrendingDown,
  Category,
...
const postFilters = [
  <SearchInput
    alwaysOn
    className="card"
    placeholder="Search Pickup Request"
    source="display_id"
    defaultValue=""
    resettable
    sx={{

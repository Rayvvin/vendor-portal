...
import PickupRequestsAsideComp from "./PickupRequestsAsideComp";
...
const PickupRequestsShowActions = ({ basePath, data, resource }) => {
  ...
  return (
    <>
      {isXLarge ? null : (
        ...
        >
          <PickupRequestsAsideComp product={product} setProduct={setProduct} />
        </Stack>
      )}
    </>
  );
...
export const PickupRequestsShow = () => {
  ...
  return (
    <Show
      title={showTitle}
      actions={<PickupRequestsShowActions />}
